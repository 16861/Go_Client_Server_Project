...
const docFileName string = "payload"
...
func main() {
	...
	decryptedText := DecryptBytes(key, originalText)
	...
	// 	fmt.Println("True")
	// }
	err = ioutil.WriteFile("file", []byte(decryptedText), 0644)
...
func Decrypt(key []byte, encryptedTextb64 string) string {
	ciphertext, _ := base64.URLEncoding.DecodeString(encryptedTextb64)
